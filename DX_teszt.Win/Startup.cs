...
public class ApplicationBuilder : IDesignTimeApplicationFactory {
    public static WinApplication BuildApplication(string connectionString) {
        ...
        builder.UseApplication<DX_tesztWindowsFormsApplication>();
        builder.Modules
            .Add<DX_teszt.Module.DX_tesztModule>()
        	.Add<DX_tesztWinModule>();
        builder.ObjectSpaceProviders
            .AddEFCore(options => options.PreFetchReferenceProperties())
                .WithDbContext<DX_teszt.Module.BusinessObjects.DX_tesztEFCoreDbContext>((application, options) => {
